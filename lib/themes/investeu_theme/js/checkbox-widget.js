...
(function ($, Drupal) {
  ...
  Drupal.facets.makeCheckbox = function () {
    ...
    var checkbox = $('<input type="checkbox" class="facets-checkbox ecl-checkbox__input">')
      .attr('id', id)
      .data($link.data())
      .data('facetsredir', href);
    var label = $('<label for="' + id + '" class="ecl-checkbox__label ecl-u-mb-xs">' + description + '</label>');
